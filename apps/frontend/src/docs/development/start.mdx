...
Welcome to the Recruitify Technical Development Getting Started Guide. Recruitify is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Recruitify and how to configure and use these technologies in your development environment.

## Basic Technology Stack

The core technology stack of Recruitify is as follows:
...
The folder directory structure of Recruitify is as follows:
...
1. **Get the code**: Clone the Recruitify code repository locally:

```bash
git clone https://github.com/RecrHub/recruitify
```

2. **Install dependencies**: Enter the project directory and install the required dependencies:

```bash
cd recruitify/apps/frontend
# If you use Bun
bun install
# If you use PNPM
pnpm install
...
Recruitify uses `i18next` to implement multilingual support, ensuring a global user experience.

Internationalization files are located in `src/locales`, containing the default language (VietNam).
...
To support developers in better understanding and using the technology stack of Recruitify, we provide a comprehensive list of resources and references — [Recruitify Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Recruitify GitHub Discussions](https://github.com/lobehub/lobe-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
