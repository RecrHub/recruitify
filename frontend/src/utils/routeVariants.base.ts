...
export const LOBE_LOCALE_COOKIE = 'RECR_LOCALE';
export const LOBE_THEME_APPEARANCE = 'RECR_THEME_APPEARANCE';
export const DEFAULT_LANG = 'en-US';

// Supported locales (keep aligned with web resources)
export const locales = [
  'ar', 'bg-BG', 'de-DE', 'en-US', 'es-ES', 'fr-FR', 'ja-JP', 'ko-KR',
  'pt-BR', 'ru-RU', 'tr-TR', 'zh-CN', 'zh-TW', 'vi-VN', 'fa-IR', 'it-IT', 'pl-PL', 'nl-NL',
] as const;
